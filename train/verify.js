...
push('［先読み］素の方策1人 vs 先読み3人  (' + SN + '局)', match({ kind: 'net', net, temp: 0.85 }, { kind: 'search', net, temp: 0.85 }, SN, 4252));
...
for (const [name, win, rew] of rows) {
  console.log(name.padEnd(w) + '  ' + win.toFixed(3) + '   ' + rew.toFixed(3));
}
console.log('\n互角なら勝率 0.250');
